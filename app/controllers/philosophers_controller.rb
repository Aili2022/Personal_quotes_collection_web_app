class PhilosophersController < ApplicationController
  ...
  def update
    if logged_in? && current_user.is_admin?
      ...
      redirect_to philosopher_url(@philosopher), notice: "You are not authorized to edit this resource."
    end  
  end
  ...
  def destroy
    if logged_in? && current_user.is_admin?
      ...
      redirect_to philosopher_url(@philosopher), notice: "You are not authorized to destroy this resource."
    end  
  end
